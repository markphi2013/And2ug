...
public class Tourist extends SherlockListActivity{
	...
	private class PagesFetcher extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			dialog = ProgressDialog.show(Tourist.this, "Loading","Wait...", true);
		}
		...
		protected void onPostExecute(String result) {
			...
			dialog.dismiss();
			PagesAdapter adapter = new PagesAdapter(Tourist.this, metrics);
