...
public class Hotel extends SherlockFragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
	        ...
	        //Add New Tab
			actionBar.addTab(actionBar.newTab().setText("Apartments").setTabListener(tabListener));
			actionBar.addTab(actionBar.newTab().setText("Clubs").setTabListener(tabListener));
			actionBar.addTab(actionBar.newTab().setText("Hotels").setTabListener(tabListener));
