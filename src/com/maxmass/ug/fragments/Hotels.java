...
public class Hotels extends SherlockListFragment{

	private DisplayMetrics metrics;  
	String tag;
	
	// All static variables
	static final String URL = "http://154.0.129.6/database/hotel/hotel.xml";
	// XML node keys
	static final String KEY_APARTMENT = "hotel"; // parent node
