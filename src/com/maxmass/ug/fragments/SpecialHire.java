...
public class SpecialHire extends SherlockListFragment{

	private DisplayMetrics metrics;  
	String tag;
	
	// All static variables
	static final String URL = "http://154.0.129.6/database/transport/specialHire.xml";
	// XML node keys
	static final String KEY_APARTMENT = "special_hire"; // parent node
